...
This application is designed to use the Open Library Cover thumbnails, made available via {their website}[http://openlibrary.org/dev/docs/api/covers]. This application assumed the use of the "medium" sized thumbnails, although other sizes could be made to work with some style changes.

...
and visiting localhost:3000/records/<document number> in your browser. If you see an error about not finding a class, try adding +config.cache_store = :null_store+ to your +config/environments/development.rb+ file.
